...
public final class Version {
    private static final String TIMESTAMP="20120217-2141";
    ...
    private static final String LONG_VERSION="4.1.2 (Build @ 20120217-2141)";
    /** Returns the library vendor such as "cloudhopper" */
    static public String getVendor() { return VENDOR; }
    /** Returns the library build timestamp such as "20120217-2141" */
    ...
    /** Returns a longer library version that includes the timestamp such as "4.1.2 (Build @ 20120217-2141)" */
