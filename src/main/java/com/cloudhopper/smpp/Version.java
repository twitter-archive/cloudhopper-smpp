...
public final class Version {
    private static final String TIMESTAMP="20111026-1713";
    ...
    private static final String LONG_VERSION="4.1.2 (Build @ 20111026-1713)";
    /** Returns the library vendor such as "cloudhopper" */
    static public String getVendor() { return VENDOR; }
    /** Returns the library build timestamp such as "20111026-1713" */
    ...
    /** Returns a longer library version that includes the timestamp such as "4.1.2 (Build @ 20111026-1713)" */
