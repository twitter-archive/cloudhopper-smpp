...
public class SslClientMain {
    ...
    static public void main(String[] args) throws Exception {
        ...
        // enable ssl
        //
        // default method - only valid certs from CAs as a client work as expected
        SSLContext sslContext = SSLContext.getDefault();
        
        // do this again, but do an init() to override trust
        // check if it overrides the default instance again
        SSLContext sslContext2 = SSLContext.getInstance("TLS");
        sslContext2.init(null, null, null);
        //sslContext2.init(null, new TrustManager[] { TRUST_ALL_MANAGER }, null);
        ...
        config0.setSslEngine(sslEngine);
