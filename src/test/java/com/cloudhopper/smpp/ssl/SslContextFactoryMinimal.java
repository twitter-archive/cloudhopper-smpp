...
/**
 * Minimal security SSLContext factory.
 * The server must have a cerificate (at least a dummy one) to initiate SSL communication.
 * Client doesn't need any certificate. The benefit of such SSLContext is the simplicity. The client doesn't need 
 * to register any certificate, and we still have encrypted communication channel.
 *
 * @author bb
 * 
 */
